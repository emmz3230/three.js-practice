 ...
 * Load model
 */
const gltf = await gltfLoader.loadAsync("static/model.glb");
...
gpgpu.particlesVariable.material.uniforms.uDeltaTime =
  new THREE.Uniform(0);
...
const tick = () => {
  ...
  gpgpu.particlesVariable.material.uniforms.uDeltaTime.value =
    deltaTime;
