...
import particlesVertexShader from "./shaders/particles-morphing/vertex.glsl";
import particlesFragmentShader from "./shaders/particles-morphing/fragment.glsl";
...
gltfLoader.load("static/models.glb", (gltf) => {
  ...
  particles.geometry.setAttribute("aSize", particles.positions[3]);
