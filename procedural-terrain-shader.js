 ...
 * Environment map
 */
rgbeLoader.load("static/spruit_sunrise.hdr", (environmentMap) => {
...
const uniforms = {
  ...
  uWrapStrength: new THREE.Uniform(0.5),
...
gui
  .add(uniforms.uStrength, "value", 0, 1, 0.001)
  .name("uStrength");
// gui
...
// boardHole.updateProjectionMatrix();
